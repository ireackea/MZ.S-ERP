      ...
      case 'general':
        return (
          <div className="space-y-6">
            <GeneralSettings settings={settings} onUpdateSettings={onUpdateSettings} forceAccess={isPrivileged} />
            <ReferenceDataSettings forceAccess={isPrivileged} />
          </div>
        );
      case 'users':
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-500">لوحة إعدادات موحدة تغطي التهيئة العامة، وبداخلها الأقسام ووحدات القياس، إضافة إلى الصلاحيات، النسخ الاحتياطية، التدقيق، والطباعة.</p>
      </div>
