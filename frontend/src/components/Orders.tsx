...
const Orders: React.FC<OrdersProps> = ({ orders, items, partners, onAddOrder, onUpdateOrder, onCompleteOrder }) => {
  ...
  const handleSaveOrder = () => {
    if (!newOrder.partnerId || !newOrder.date || (newOrder.items?.length || 0) === 0) {
      toast.error('8y7�7�80 7�7�7�8y7�7� 7�87�7�8y8� 8�7�87�7�7�8y7� 8�7�7�7�8~7� 7�8 8~ 8�7�7�7� 7�880 7�87�88');
      return;
    }
  ...
  const handleComplete = (order: Order) => {
    toast.warning('8!8 7�8 7� 8&7�7�8�7� 8&8  7�8�8&7�8 7�87�87�7� 7�8y7�8& 7�7�7�8y7� 7�88&7�7�8�8  7�887�7�8y7�89.', {
      action: {
        label: '7�7�8�8y7�',
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-slate-800">
               {activeType === 'purchase' ? '7�87� 7�7�7�7 8&8�7�7� 7�7�8&' : '7�87� 7�8y7� 8&8 7�7�7�7�'} 7�7�8y7�
            </h2>
          </div>
        </div>
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
             <div>
               <label className="block text-sm font-medium text-slate-700 mb-1">
                 {activeType === 'purchase' ? '7�88&8�7�7�' : '7�87�8&8y8'}
               </label>
               <select 
             ...
             <div>
               <label className="block text-sm font-medium text-slate-700 mb-1">7�87�7�7�8y7�</label>
             ...
             <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">8&87�7�7�7�7�</label>
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
             <h3 className="font-bold text-slate-700 mb-4">7�87�7�8 7�8~ 7�88&7�88�7�7�</h3>
             <div className="flex gap-2 mb-4">
                ...
                <input type="number" placeholder="7�88�8&8y7�" className="w-24 p-2 border rounded-lg" value={currentItem.quantity || ''} onChange={e => setCurrentItem({...currentItem, quantity: Number(e.target.value)})} />
             ...
             <div className="space-y-2 max-h-60 overflow-y-auto">
                ...
                {(!newOrder.items || newOrder.items.length === 0) && <p className="text-center text-slate-400 text-sm">88& 8y7�8& 7�7�7�8~7� 7�7�8 7�8~</p>}
             </div>
          </div>
        </div>
        
        <div className="p-6 border-t border-slate-100 flex justify-end gap-3">
          <button onClick={() => setViewMode('list')} className="px-6 py-2 text-slate-600 hover:bg-slate-100 rounded-xl">7�877�7</button>
          <button onClick={handleSaveOrder} className="px-6 py-2 bg-slate-800 text-white hover:bg-slate-900 rounded-xl shadow-lg">7�8~7� 7�87�87�</button>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
       <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
          <div>
            <h2 className="text-2xl font-bold text-slate-800">7�7�7�7�7� 7�87�87�7�7�</h2>
            <p className="text-slate-500">8 7�7�8& 7�88&7�8y7�7�7� 8�7�88&7�7�7�8y7�7�</p>
          </div>
          <button onClick={() => setViewMode('create')} className="flex items-center gap-2 px-6 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition shadow-lg">
            <Plus size={20} /> 7�8 7�7�7 7�87� 7�7�8y7�
          </button>
        </div>

        <div className="flex border-b border-slate-200">
           <button onClick={() => setActiveType('purchase')} className={`px-6 py-3 font-medium text-sm transition-colors border-b-2 ${activeType === 'purchase' ? 'border-emerald-500 text-emerald-700' : 'border-transparent text-slate-500'}`}>7�87�7�7� 7�7�7�7 (8&8�7�7�7�)</button>
           <button onClick={() => setActiveType('sale')} className={`px-6 py-3 font-medium text-sm transition-colors border-b-2 ${activeType === 'sale' ? 'border-emerald-500 text-emerald-700' : 'border-transparent text-slate-500'}`}>7�87�7�7� 7�8y7� (8&8 7�7�7�7�)</button>
        </div>
      </div>
      ...
      <div className="space-y-4">
          ...
          <div key={order.id} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md transition">
            <div className="flex justify-between items-start mb-4">
                 ...
                 <div>
                    <h3 className="font-bold text-slate-800 text-lg flex items-center gap-2">
                      ...
                      <span className={`text-xs px-2 py-1 rounded-full ${order.status === 'completed' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'}`}>
                        {order.status === 'completed' ? '8&8�7�8&8' : '88y7� 7�87�8 7�7�7�7�'}
                      </span>
                    </h3>
              ...
              {order.status === 'pending' && (
                ...
                >
                  <CheckCircle size={16} /> 7�8�8&7�8 8�7�7�7�8y7� 7�88&7�7�8�8 
                </button>
              )}
            </div>

            <div className="bg-slate-50 rounded-xl p-4 border border-slate-100">
               <h4 className="font-bold text-xs text-slate-500 mb-2 uppercase tracking-wider">7�8~7�7�8y8 7�87�7�8 7�8~</h4>
        ...
        {filteredOrders.length === 0 && (
           <div className="text-center py-12 text-slate-400">87� 7�8�7�7� 7�87�7�7� 8~8y 8!7�8! 7�887�7�8&7�</div>
        )}
      </div>
    </div>
  );
